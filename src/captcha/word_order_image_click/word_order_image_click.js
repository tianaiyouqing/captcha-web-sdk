...
import "@/captcha/image_click/image_click.scss"
import $ from "jquery"
...
const TYPE = "WORD_ORDER_IMAGE_CLICK"
const template =
    `
...
`
class WordOrderImageClick extends CommonCaptcha{
...
export default WordOrderImageClick;
